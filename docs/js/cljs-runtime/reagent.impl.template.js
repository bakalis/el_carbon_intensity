...
var G__38553 = o;
reagent.impl.template.goog$module$goog$object.set(G__38553,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__38571__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__38571 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38572__i = 0, G__38572__a = new Array(arguments.length -  0);
while (G__38572__i < G__38572__a.length) {G__38572__a[G__38572__i] = arguments[G__38572__i + 0]; ++G__38572__i;}
  args = new cljs.core.IndexedSeq(G__38572__a,0,null);
} 
return G__38571__delegate.call(this,args);};
G__38571.cljs$lang$maxFixedArity = 0;
G__38571.cljs$lang$applyTo = (function (arglist__38573){
var args = cljs.core.seq(arglist__38573);
return G__38571__delegate(args);
});
G__38571.cljs$core$IFn$_invoke$arity$variadic = G__38571__delegate;
return G__38571;
})()
;
} else {
...
var G__38554 = o;
reagent.impl.template.goog$module$goog$object.set(G__38554,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__38574__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__38574 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38575__i = 0, G__38575__a = new Array(arguments.length -  0);
while (G__38575__i < G__38575__a.length) {G__38575__a[G__38575__i] = arguments[G__38575__i + 0]; ++G__38575__i;}
  args = new cljs.core.IndexedSeq(G__38575__a,0,null);
} 
return G__38574__delegate.call(this,args);};
G__38574.cljs$lang$maxFixedArity = 0;
G__38574.cljs$lang$applyTo = (function (arglist__38576){
var args = cljs.core.seq(arglist__38576);
return G__38574__delegate(args);
});
G__38574.cljs$core$IFn$_invoke$arity$variadic = G__38574__delegate;
return G__38574;
})()
;
} else {
...
var G__38555 = props;
var G__38555__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38555,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38555);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38555__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38556 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38556,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38556;
}
})(),id_class);
...
var temp__5825__auto___38577 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___38577)){
var d_38578 = temp__5825__auto___38577;
if((d_38578 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_38578.s}));
} else {
...
var G__38557 = (cljs.core.count(argv) - first_child);
switch (G__38557) {
case (0):
...
var vec__38558 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38558,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38558,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38558,(2),null);
...
var temp__5829__auto___38580 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___38580 == null)){
} else {
var key_38581 = temp__5829__auto___38580;
(jsprops.key = key_38581);
}
...
var temp__5829__auto___38582 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___38582 == null)){
} else {
var key_38583 = temp__5829__auto___38582;
...
var temp__5829__auto___38584 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___38584 == null)){
} else {
var key_38585 = temp__5829__auto___38584;
(jsprops.key = key_38585);
}
...
var temp__5829__auto___38586 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___38586 == null)){
} else {
var key_38587 = temp__5829__auto___38586;
(jsprops.key = key_38587);
}
...
var temp__5829__auto___38588 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___38588 == null)){
} else {
var key_38589 = temp__5829__auto___38588;
(jsprops.key = key_38589);
}
...
var temp__5829__auto___38590 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___38590 == null)){
} else {
var key_38591 = temp__5829__auto___38590;
(jsprops.key = key_38591);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38561_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38561_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38562 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38562,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38562,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template38568 = (function (opts,id,fn_to_element,parse_fn,meta38569){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38568.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38570,meta38569__$1){
var self__ = this;
var _38570__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38568(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38569__$1));
}));

(reagent.impl.template.t_reagent$impl$template38568.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38570){
var self__ = this;
var _38570__$1 = this;
return self__.meta38569;
}));

(reagent.impl.template.t_reagent$impl$template38568.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38568.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38568.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38568.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38568.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38568.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38569","meta38569",-813514092,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38568.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38568.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38568");

(reagent.impl.template.t_reagent$impl$template38568.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template38568");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38568.
 */
reagent.impl.template.__GT_t_reagent$impl$template38568 = (function reagent$impl$template$__GT_t_reagent$impl$template38568(opts,id,fn_to_element,parse_fn,meta38569){
return (new reagent.impl.template.t_reagent$impl$template38568(opts,id,fn_to_element,parse_fn,meta38569));
});
...
return (new reagent.impl.template.t_reagent$impl$template38568(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
