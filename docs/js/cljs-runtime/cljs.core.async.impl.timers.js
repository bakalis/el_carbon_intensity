...
var i_30852 = (self__.level + (1));
while(true){
if((i_30852 <= (new_level + (1)))){
(update[i_30852] = self__.header);

var G__30855 = (i_30852 + (1));
i_30852 = G__30855;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_30857 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30857[i]));
} else {
x__$2.forward.push((((i < links_30857.length))?(links_30857[i]):null));
}

if((i < links_30857.length)){
(links_30857[i] = x__$2);
} else {
links_30857.push(x__$2);
}
...
var i_30863 = (0);
while(true){
if((i_30863 <= self__.level)){
var links_30864 = (update[i_30863]).forward;
if((x__$1 === (((i_30863 < links_30864.length))?(links_30864[i_30863]):null))){
(links_30864[i_30863] = (x__$1.forward[i_30863]));

var G__30866 = (i_30863 + (1));
i_30863 = G__30866;
continue;
} else {
var G__30867 = (i_30863 + (1));
i_30863 = G__30867;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__30877 = nx;
var G__30878 = (level__$1 - (1));
x = G__30877;
level__$1 = G__30878;
continue;
} else {
var G__30879 = x;
var G__30880 = (level__$1 - (1));
x = G__30879;
level__$1 = G__30880;
continue;
}
