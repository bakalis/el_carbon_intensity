...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38501 = c;
var G__38501__$1 = (((G__38501 == null))?null:G__38501.prototype);
if((G__38501__$1 == null)){
return null;
} else {
return G__38501__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38504 = c;
var G__38504__$1 = (((G__38504 == null))?null:G__38504.prototype);
if((G__38504__$1 == null)){
return null;
} else {
return G__38504__$1.render;
}
})() == null)))));
});
...
var or__5025__auto__ = (function (){var G__38517 = c;
var G__38517__$1 = (((G__38517 == null))?null:G__38517.constructor);
if((G__38517__$1 == null)){
return null;
} else {
return G__38517__$1.displayName;
}
})();
...
var G__38518 = c;
var G__38518__$1 = (((G__38518 == null))?null:G__38518.constructor);
if((G__38518__$1 == null)){
return null;
} else {
return G__38518__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38519 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38520 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38520);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38519);
}});
...
var G__38521 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__38521 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__38521);
}
} else {
return null;
}
...
var renders_38538 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_38539 = cljs.core.first(cljs.core.vals(renders_38538));
...
if((cljs.core.count(renders_38538) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38538))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38539)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38539], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38524 = o;
reagent.impl.component.goog$module$goog$object.set(G__38524,cljs.core.name(k),v);
...
return (function() { 
var G__38546__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
return G__38546__delegate.call(this,args);};
...
return G__38546__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__38525 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38526 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38526);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38525);
}});
...
var vec__38527 = module$node_modules$react$index.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38527,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38527,(1),null);
