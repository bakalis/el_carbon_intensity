...
var shadow$remote$runtime$api$IRuntime$add_extension$dyn_31091 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_31091(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_31095 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_31095(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_31096 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_31096(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31101 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31101(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31107 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31107(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__31082,callback){
var map__31083 = p__31082;
var map__31083__$1 = cljs.core.__destructure_map(map__31083);
var input = map__31083__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31083__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31083__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
