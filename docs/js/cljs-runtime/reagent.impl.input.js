...
var G__38551 = shadow_root.activeElement;
active_element = G__38551;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__38540){
var map__38541 = p__38540;
var map__38541__$1 = cljs.core.__destructure_map(map__38541);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38541__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__38542 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__38543 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__38543);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__38542);
}}));
} else {
...
(jsprops.onChange = (function (p1__38544_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__38544_SHARP_);
}));
